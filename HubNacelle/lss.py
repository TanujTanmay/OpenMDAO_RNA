...
from fixed_parameters import mb1Type, mb2Type, safety_factor, beautify
...
class LSS(ExplicitComponent):
    def setup(self):
        ...
        #self.add_input('shaft_ratio', desc='Ratio of inner diameter to outer diameter.  Leave zero for solid LSS')
...
class DriveSE3pt(LSS):
    def compute(self, inputs, outputs):
        ...
        self.mb1Type = mb1Type
        self.mb2Type = mb2Type
...
class LSSTest(Group):
    def setup(self):
        ...
        # design variables
        i.add_output('rotor_bending_moment', units='N*m', desc='The bending moment about the x axis', shape=3)
        ...
        i.add_output('gearbox_mass', units='kg', desc='Gearbox mass')
        ...
        i.add_output('gearbox_cm', units = 'm', desc = 'center of mass of gearbox', shape=3)
        i.add_output('gearbox_length', units='m', desc='gearbox length')
        #i.add_output('flange_length', units='m', desc ='flange length')
        i.add_output('shaft_angle', units='rad', desc='Angle of the LSS inclindation with respect to the horizontal')
        ...
        self.add_subsystem('sys', DriveSE3pt(), promotes_inputs=['*'])
    ...
    def unit_test(self):
        ...
        prob['dof.rotor_mass'] = 0.0 #51092.6639
        prob['dof.rotor_diameter'] = 126.0
        prob['dof.machine_rating'] = 5000.0 
        prob['dof.gearbox_mass'] = 0.0 #58594.4943
        #prob['dof.carrier_mass'] = 8000.0
        prob['dof.overhang'] = 5.0
        #prob['dof.L_rb'] = 1.912 
        #prob['dof.shrink_disc_mass'] = 333.3*5000.0/1000.0 
        prob['dof.gearbox_cm'] = np.zeros(3) #[0.1  , 0.   , 0.756]
        prob['dof.gearbox_length'] = 0 #1.512
        ...
        beautify('diameter1', prob['sys.diameter1'])
        beautify('diameter2', prob['sys.diameter2'])
        beautify('mass', prob['sys.mass'])
        beautify('cm', prob['sys.cm'])
        beautify('I', prob['sys.I'])
        beautify('FW_mb1', prob['sys.FW_mb1'])
        beautify('FW_mb2', prob['sys.FW_mb2'])
        beautify('bearing_mass1', prob['sys.bearing_mass1'])
        beautify('bearing_mass2', prob['sys.bearing_mass2'])
        beautify('bearing_location1', prob['sys.bearing_location1'])
        beautify('bearing_location2', prob['sys.bearing_location2'])        
    ...
    def test5(self):
        ...
        for j in range(3):
            ...
            for i in i_list:
                ...
                prob['dof.rotor_diameter'] = 126.0
                prob['dof.machine_rating'] = 5000.0 
                prob['dof.gearbox_mass'] = 58594.4943
                #prob['dof.carrier_mass'] = 8000.0
                prob['dof.overhang'] = 5.0
                #prob['dof.L_rb'] = 1.912 
                #prob['dof.shrink_disc_mass'] = 333.3*5000.0/1000.0 
                ...
                mass_list.append(prob['sys.mass'][0]/11271.924)
            plt.plot(i_list, mass_list, label='M'+str(j))   
                # print outputs 
#                 print "DriveSE LSS"
#                 beautify('length', prob['sys.length'])
#                 beautify('diameter1', prob['sys.diameter1'])
...
#                 beautify('bearing_location2', prob['sys.bearing_location2'])
        ...
        for j in range(3):
            ...
            for i in i_list:
                ...
                mass_list.append(prob['sys.mass'][0]/11271.924)
            plt.plot(i_list, mass_list, label='F'+str(j)) 
    ...
    def test1_5(self):
        ...
        # define inputs
        prob['dof.rotor_bending_moment'] = [8.4389e5, -2.6758e6 , 7.5222e2]
        prob['dof.rotor_force'] = [2.6204e5, 2.8026e4, -3.4763e5]
        prob['dof.rotor_mass'] = 53220.0
        prob['dof.rotor_diameter'] = 77.0
        prob['dof.machine_rating'] = 1500.0 
        prob['dof.gearbox_mass'] = 19058.0795
        prob['dof.carrier_mass'] = 2000.0
        prob['dof.overhang'] = 4.0
        prob['dof.L_rb'] = 1.0
        prob['dof.shrink_disc_mass'] = 333.3*1500.0/1000.0 
        prob['dof.gearbox_cm'] = [0.   , 0.   , 0.462]
        prob['dof.gearbox_length'] = 0.924
        prob['dof.flange_length'] = 0.285 
        prob['dof.shaft_angle'] = 5.0
        prob['dof.shaft_ratio'] = 0.10
