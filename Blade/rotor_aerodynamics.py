...
##############################  MODEL 1: AERODYN ############################
#############################################################################
class AeroDyn(RotorAerodynamics):
    ...
    def compute(self, inputs, outputs):
        ...
        #print design_tsr, WndSpeed, RotRad, RotSpd
...
class RotorAerodynamicsTest(Group):
    def setup(self):
        ...
        self.add_subsystem('aero', BEM(), promotes_inputs=['*'])
